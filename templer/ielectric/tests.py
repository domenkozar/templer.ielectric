    ...
    def test_everything(self):
        ...
        self.assertEqual(
            ...
            set([
                ...
                'proj/src/proj/locale',
                'proj/src/proj/locale/proj.pot',
                'proj/src/proj/scripts',
                'proj/src/proj/scripts/__init__.py',
                'proj/src/proj/scripts/migrate_database.py',
                'proj/src/proj/site',
